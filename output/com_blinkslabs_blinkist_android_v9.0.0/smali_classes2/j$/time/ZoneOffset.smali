...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/ZoneOffset;->e:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static t(Lj$/time/temporal/TemporalAccessor;)Lj$/time/ZoneOffset;
    .locals 3
...
.method public static w(Ljava/lang/String;)Lj$/time/ZoneOffset;
    .locals 7
    ...
    sget-object v0, Lj$/time/ZoneOffset;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/ZoneOffset;->z(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/ZoneOffset;->z(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/ZoneOffset;->z(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/ZoneOffset;->z(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/ZoneOffset;->z(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v0, v1}, Lj$/time/ZoneOffset;->x(III)Lj$/time/ZoneOffset;
    ...
    :cond_9
    invoke-static {v0, v1, v2}, Lj$/time/ZoneOffset;->x(III)Lj$/time/ZoneOffset;
...
.method public static x(III)Lj$/time/ZoneOffset;
    .locals 4
...
.method public static y(I)Lj$/time/ZoneOffset;
    .locals 3
    ...
    sget-object p0, Lj$/time/ZoneOffset;->e:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final get(Lj$/time/temporal/TemporalField;)I
    ...
    .line 2
    invoke-virtual {p0, p1}, Lj$/time/ZoneOffset;->d(Lj$/time/temporal/TemporalField;)J

    move-result-wide v1

    invoke-virtual {v0, v1, v2, p1}, Lj$/time/temporal/u;->a(JLj$/time/temporal/TemporalField;)I
...
.method public final h(Lj$/time/temporal/s;)Ljava/lang/Object;
    ...
    :cond_0
    invoke-super {p0, p1}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/s;)Ljava/lang/Object;
