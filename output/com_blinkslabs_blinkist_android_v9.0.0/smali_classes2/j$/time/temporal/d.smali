...
.method public final j(Lj$/time/temporal/Temporal;J)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {v0, p2, p3, p0}, Lj$/time/temporal/u;->b(JLj$/time/temporal/TemporalField;)J
...
.method public final k(Lj$/time/temporal/TemporalAccessor;)J
    ...
    invoke-static {p1}, Lj$/time/temporal/f;->z(Lj$/time/LocalDate;)I
...
.method public final p(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/u;
    ...
    invoke-static {p1}, Lj$/time/temporal/f;->y(Lj$/time/LocalDate;)Lj$/time/temporal/u;
...
.method public final q(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/F;)Lj$/time/temporal/TemporalAccessor;
    ...
    :cond_0
    invoke-interface {v3}, Lj$/time/temporal/TemporalField;->m()Lj$/time/temporal/u;
    ...
    invoke-virtual {v7, v8, v9, v3}, Lj$/time/temporal/u;->a(JLj$/time/temporal/TemporalField;)I
    ...
    invoke-static/range {p2 .. p2}, Lj$/time/temporal/f;->x(Lj$/time/temporal/TemporalAccessor;)V

    const/4 v9, 0x1

    const/4 v10, 0x4

    invoke-static {v4, v9, v10}, Lj$/time/LocalDate;->A(III)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v10, v11}, Lj$/time/LocalDate;->F(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v9, v10}, Lj$/time/LocalDate;->F(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v6, v7}, Lj$/time/LocalDate;->F(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v5, v11, v12}, Lj$/time/temporal/ChronoField;->v(J)I
    ...
    invoke-static {v4}, Lj$/time/temporal/f;->y(Lj$/time/LocalDate;)Lj$/time/temporal/u;
    ...
    :cond_6
    invoke-virtual/range {p0 .. p0}, Lj$/time/temporal/d;->m()Lj$/time/temporal/u;

    move-result-object v2

    :goto_4
    invoke-virtual {v2, v7, v8, v0}, Lj$/time/temporal/u;->b(JLj$/time/temporal/TemporalField;)J
    ...
    invoke-virtual {v4, v7, v8}, Lj$/time/LocalDate;->F(J)Lj$/time/LocalDate;
