...
.method private b(Lj$/time/format/y;Ljava/lang/CharSequence;IILj$/time/format/m;)I
    ...
    invoke-virtual {p5, v1, p2, p4}, Lj$/time/format/m;->i(Lj$/time/format/y;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, p4}, Lj$/time/format/y;->j(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;
    ...
    invoke-static {p4}, Lj$/time/ZoneOffset;->y(I)Lj$/time/ZoneOffset;

    move-result-object p4

    invoke-static {v0, p4}, Lj$/time/ZoneId;->p(Ljava/lang/String;Lj$/time/ZoneOffset;)Lj$/time/ZoneId;
...
.method public g(Lj$/time/format/A;Ljava/lang/StringBuilder;)Z
    .locals 1
