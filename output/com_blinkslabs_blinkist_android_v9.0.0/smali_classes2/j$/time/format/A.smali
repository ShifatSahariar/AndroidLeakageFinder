...
.method constructor <init>(Lj$/time/temporal/TemporalAccessor;Lj$/time/format/DateTimeFormatter;)V
    ...
    .line 1
    invoke-virtual {p2}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/e;
    ...
    :cond_0
    sget v2, Lj$/time/temporal/k;->a:I
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/TemporalField;)Z
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/TemporalField;)Z
    ...
    invoke-virtual {v7}, Lj$/time/temporal/ChronoField;->i()Z
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/z;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/TemporalAccessor;Lj$/time/chrono/e;Lj$/time/ZoneId;)V
