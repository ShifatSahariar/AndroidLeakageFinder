...
.method private constructor <init>(Lj$/time/ZoneOffset;)V
    ...
    iput-object v0, p0, Lj$/time/zone/c;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private a(Lj$/time/LocalDateTime;Lj$/time/zone/a;)Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Lj$/time/zone/a;->i()Lj$/time/LocalDateTime;

    move-result-object v0

    invoke-virtual {p2}, Lj$/time/zone/a;->t()Z

    move-result v1

    invoke-virtual {p1, v0}, Lj$/time/LocalDateTime;->t(Lj$/time/chrono/c;)Z
    ...
    invoke-virtual {p2}, Lj$/time/zone/a;->p()Lj$/time/ZoneOffset;
    ...
    :cond_0
    invoke-virtual {p2}, Lj$/time/zone/a;->g()Lj$/time/LocalDateTime;
...
.method private b(I)[Lj$/time/zone/a;
    ...
    iget-object v3, v0, Lj$/time/zone/c;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v3}, Lj$/time/LocalDateTime;->v(I)Lj$/time/LocalDateTime;
    ...
    invoke-interface {v3, v4}, Lj$/time/chrono/c;->u(Lj$/time/ZoneOffset;)J
    ...
    invoke-static {v14, v15, v5, v6}, Ljava/lang/Math;->floorDiv(JJ)J
    ...
    invoke-static {v6}, Lj$/time/zone/c;->k(I)Lj$/time/ZoneOffset;

    move-result-object v9

    invoke-direct {v0, v3, v4, v9}, Lj$/time/zone/c;->c(JLj$/time/ZoneOffset;)I
    ...
    invoke-direct {v12, v3, v4, v5, v9}, Lj$/time/zone/a;-><init>(JLj$/time/ZoneOffset;Lj$/time/ZoneOffset;)V
    ...
    iget-object v1, v0, Lj$/time/zone/c;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, v2, v11}, Ljava/util/concurrent/ConcurrentHashMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private e(Lj$/time/LocalDateTime;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v1}, Lj$/time/chrono/c;->u(Lj$/time/ZoneOffset;)J
    ...
    invoke-virtual {v1}, Lj$/time/zone/a;->p()Lj$/time/ZoneOffset;
...
.method private static k(I)Lj$/time/ZoneOffset;
    ...
    invoke-static {p0}, Lj$/time/ZoneOffset;->y(I)Lj$/time/ZoneOffset;
...
.method public final d(Lj$/time/Instant;)Lj$/time/ZoneOffset;
    ...
    invoke-virtual {p1}, Lj$/time/Instant;->y()J
    ...
    invoke-virtual {v0}, Lj$/time/zone/a;->p()Lj$/time/ZoneOffset;
    ...
    :cond_3
    invoke-virtual {v0}, Lj$/time/zone/a;->m()Lj$/time/ZoneOffset;
...
.method public final i()Z
    ...
    :cond_0
    invoke-static {}, Lj$/time/Instant;->p()Lj$/time/Instant;
    ...
    invoke-virtual {v6}, Lj$/time/zone/a;->toEpochSecond()J
    ...
    invoke-static {}, Lj$/time/c;->e()Lj$/time/c;

    move-result-object v1

    invoke-virtual {v1}, Lj$/time/c;->c()J
    ...
    invoke-static {v4, v2, v2}, Lj$/time/LocalDate;->A(III)Lj$/time/LocalDate;
    ...
    invoke-virtual {v12}, Lj$/time/zone/a;->toEpochSecond()J
