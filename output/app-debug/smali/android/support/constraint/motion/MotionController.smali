...
.method public setup(IIFJ)V
    ...
    .line 491
    .local v7, "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    iget v8, v0, Landroid/support/constraint/motion/MotionController;->mPathMotionArc:I

    sget v9, Landroid/support/constraint/motion/Key;->UNSET:I
    ...
    iget v9, v0, Landroid/support/constraint/motion/MotionController;->mPathMotionArc:I

    iput v9, v8, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I

    .line 495
    :cond_0
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mStartPoint:Landroid/support/constraint/motion/MotionConstrainedPoint;

    iget-object v9, v0, Landroid/support/constraint/motion/MotionController;->mEndPoint:Landroid/support/constraint/motion/MotionConstrainedPoint;

    invoke-virtual {v8, v9, v4}, Landroid/support/constraint/motion/MotionConstrainedPoint;->different(Landroid/support/constraint/motion/MotionConstrainedPoint;Ljava/util/HashSet;)V

    .line 501
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mKeyList:Ljava/util/ArrayList;
    ...
    .line 503
    .local v9, "key":Landroid/support/constraint/motion/Key;
    instance-of v10, v9, Landroid/support/constraint/motion/KeyPosition;
    ...
    check-cast v10, Landroid/support/constraint/motion/KeyPosition;

    .line 505
    .local v10, "keyPath":Landroid/support/constraint/motion/KeyPosition;
    ...
    invoke-direct/range {v11 .. v16}, Landroid/support/constraint/motion/MotionPaths;-><init>(IILandroid/support/constraint/motion/KeyPosition;Landroid/support/constraint/motion/MotionPaths;Landroid/support/constraint/motion/MotionPaths;)V

    invoke-direct {v0, v2}, Landroid/support/constraint/motion/MotionController;->insertKey(Landroid/support/constraint/motion/MotionPaths;)V

    .line 506
    iget v2, v10, Landroid/support/constraint/motion/KeyPosition;->mCurveFit:I

    sget v11, Landroid/support/constraint/motion/Key;->UNSET:I
    ...
    iput v2, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I

    .line 509
    .end local v10    # "keyPath":Landroid/support/constraint/motion/KeyPosition;
    :cond_1
    goto :goto_1
    ...
    instance-of v2, v9, Landroid/support/constraint/motion/KeyCycle;

    if-eqz v2, :cond_3

    .line 510
    invoke-virtual {v9, v5}, Landroid/support/constraint/motion/Key;->getAttributeNames(Ljava/util/HashSet;)V

    goto :goto_1

    .line 511
    :cond_3
    instance-of v2, v9, Landroid/support/constraint/motion/KeyTimeCycle;

    if-eqz v2, :cond_4

    .line 512
    invoke-virtual {v9, v3}, Landroid/support/constraint/motion/Key;->getAttributeNames(Ljava/util/HashSet;)V

    goto :goto_1

    .line 513
    :cond_4
    instance-of v2, v9, Landroid/support/constraint/motion/KeyTrigger;
    ...
    check-cast v2, Landroid/support/constraint/motion/KeyTrigger;
    ...
    .line 519
    :cond_6
    invoke-virtual {v9, v6}, Landroid/support/constraint/motion/Key;->setInterpolation(Ljava/util/HashMap;)V

    .line 520
    invoke-virtual {v9, v4}, Landroid/support/constraint/motion/Key;->getAttributeNames(Ljava/util/HashSet;)V

    .line 522
    .end local v9    # "key":Landroid/support/constraint/motion/Key;
    :goto_1
    ...
    .line 528
    new-array v8, v2, [Landroid/support/constraint/motion/KeyTrigger;
    ...
    iput-object v8, v0, Landroid/support/constraint/motion/MotionController;->mKeyTriggers:[Landroid/support/constraint/motion/KeyTrigger;
    ...
    iput-object v8, v0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;
    ...
    .line 562
    .local v13, "attrList":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/support/constraint/ConstraintAttribute;>;"
    ...
    iget-object v15, v0, Landroid/support/constraint/motion/MotionController;->mKeyList:Ljava/util/ArrayList;
    ...
    check-cast v11, Landroid/support/constraint/motion/Key;

    .line 564
    .local v11, "key":Landroid/support/constraint/motion/Key;
    iget-object v2, v11, Landroid/support/constraint/motion/Key;->mCustomConstraints:Ljava/util/HashMap;
    ...
    .line 568
    .local v2, "customAttribute":Landroid/support/constraint/ConstraintAttribute;
    if-eqz v2, :cond_b

    .line 569
    move-object/from16 v19, v7

    .end local v7    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    .local v19, "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    iget v7, v11, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    .line 568
    .end local v19    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    .restart local v7    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    :cond_b
    move-object/from16 v19, v7

    .line 571
    .end local v2    # "customAttribute":Landroid/support/constraint/ConstraintAttribute;
    .end local v7    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    .end local v11    # "key":Landroid/support/constraint/motion/Key;
    .restart local v19    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    :goto_5
    ...
    .end local v7    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    .restart local v19    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    invoke-static {v12, v13}, Landroid/support/constraint/motion/SplineSet;->makeCustomSpline(Ljava/lang/String;Landroid/util/SparseArray;)Landroid/support/constraint/motion/SplineSet;

    move-result-object v2

    .line 573
    .end local v13    # "attrList":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/support/constraint/ConstraintAttribute;>;"
    .end local v14    # "customAttributeName":Ljava/lang/String;
    .local v2, "splineSets":Landroid/support/constraint/motion/SplineSet;
    goto :goto_6

    .line 574
    .end local v2    # "splineSets":Landroid/support/constraint/motion/SplineSet;
    .end local v19    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    .restart local v7    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    :cond_d
    move-object/from16 v19, v7
    ...
    .end local v7    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    .restart local v19    # "triggerList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/KeyTrigger;>;"
    invoke-static {v12}, Landroid/support/constraint/motion/SplineSet;->makeSpline(Ljava/lang/String;)Landroid/support/constraint/motion/SplineSet;

    move-result-object v2

    .line 576
    .restart local v2    # "splineSets":Landroid/support/constraint/motion/SplineSet;
    :goto_6
    if-nez v2, :cond_e
    ...
    .line 579
    :cond_e
    invoke-virtual {v2, v12}, Landroid/support/constraint/motion/SplineSet;->setType(Ljava/lang/String;)V
    ...
    instance-of v8, v7, Landroid/support/constraint/motion/KeyAttributes;
    ...
    invoke-virtual {v7, v8}, Landroid/support/constraint/motion/Key;->addValues(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v2, v7, v8}, Landroid/support/constraint/motion/MotionConstrainedPoint;->addValues(Ljava/util/HashMap;I)V

    .line 590
    iget-object v2, v0, Landroid/support/constraint/motion/MotionController;->mEndPoint:Landroid/support/constraint/motion/MotionConstrainedPoint;
    ...
    invoke-virtual {v11, v8}, Landroid/support/constraint/motion/SplineSet;->setup(I)V
    ...
    iput-object v2, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    .line 612
    .local v8, "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    ...
    iget v2, v14, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    .line 625
    .end local v8    # "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    ...
    .local v2, "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    move-wide/from16 v11, p4

    goto :goto_c

    .line 626
    .end local v2    # "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    .restart local v8    # "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    :cond_1a
    move-object/from16 v20, v2
    ...
    .line 629
    .end local v8    # "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    .restart local v2    # "splineSets":Landroid/support/constraint/motion/TimeCycleSplineSet;
    :goto_c
    if-nez v2, :cond_1b
    ...
    .line 632
    :cond_1b
    invoke-virtual {v2, v7}, Landroid/support/constraint/motion/TimeCycleSplineSet;->setType(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v9}, Landroid/support/constraint/motion/KeyTimeCycle;->addTimeValues(Ljava/util/HashMap;)V
    ...
    check-cast v9, Landroid/support/constraint/motion/TimeCycleSplineSet;

    invoke-virtual {v9, v8}, Landroid/support/constraint/motion/TimeCycleSplineSet;->setup(I)V
    ...
    .line 655
    :cond_21
    iget-object v2, v0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    new-array v2, v2, [Landroid/support/constraint/motion/MotionPaths;

    .line 656
    .local v2, "points":[Landroid/support/constraint/motion/MotionPaths;
    const/4 v8, 0x1

    .line 657
    .local v8, "count":I
    iget-object v9, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;
    ...
    .line 659
    iget-object v9, v0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    iput v9, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I
    ...
    invoke-virtual {v3}, Landroid/support/constraint/ConstraintAttribute;->noOfInterpValues()I
    ...
    iget v3, v7, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
    ...
    invoke-virtual {v14, v15, v7, v4, v3}, Landroid/support/constraint/motion/MotionPaths;->different(Landroid/support/constraint/motion/MotionPaths;[Z[Ljava/lang/String;Z)V
    ...
    iput-object v10, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D
    ...
    invoke-virtual {v15, v3, v4}, Landroid/support/constraint/motion/MotionPaths;->fillStandard([D[I)V

    .line 719
    aget-object v3, v2, v14

    iget v3, v3, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    new-array v3, v3, [Landroid/support/constraint/motion/utils/CurveFit;

    iput-object v3, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-virtual {v9, v4}, Landroid/support/constraint/motion/MotionPaths;->hasCustomData(Ljava/lang/String;)Z
    ...
    invoke-virtual {v11, v4}, Landroid/support/constraint/motion/MotionPaths;->getCustomDataCount(Ljava/lang/String;)I
    ...
    invoke-virtual {v9, v4, v11, v12}, Landroid/support/constraint/motion/MotionPaths;->getCustomData(Ljava/lang/String;[DI)I
    ...
    iget v13, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I

    invoke-static {v13, v9, v7}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    iget v4, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I

    invoke-static {v4, v10, v8}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    iget v3, v3, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I

    sget v4, Landroid/support/constraint/motion/Key;->UNSET:I
    ...
    .end local v7    # "i":I
    :cond_37
    invoke-static {v4, v6, v1}, Landroid/support/constraint/motion/utils/CurveFit;->getArc([I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-static {v4}, Landroid/support/constraint/motion/KeyCycleOscillator;->makeSpline(Ljava/lang/String;)Landroid/support/constraint/motion/KeyCycleOscillator;
    ...
    .line 787
    :cond_3a
    invoke-virtual {v6, v4}, Landroid/support/constraint/motion/KeyCycleOscillator;->setType(Ljava/lang/String;)V
    ...
    .line 791
    .local v4, "key":Landroid/support/constraint/motion/Key;
    instance-of v6, v4, Landroid/support/constraint/motion/KeyCycle;
    ...
    .line 796
    .local v4, "cycle":Landroid/support/constraint/motion/KeyCycleOscillator;
    invoke-virtual {v4, v1}, Landroid/support/constraint/motion/KeyCycleOscillator;->setup(F)V

    .line 797
    .end local v4    # "cycle":Landroid/support/constraint/motion/KeyCycleOscillator;
    goto :goto_23
