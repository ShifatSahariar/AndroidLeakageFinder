...
# interfaces
.implements Lcom/google/android/gms/internal/zzfkt;
...
.method public static zzi(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/zzfkr;->zzff(Landroid/content/Context;)Ljava/lang/String;
...
.method public final mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    iget-object p2, p0, Lcom/google/android/gms/internal/zznn;->zzbre:Landroid/support/customtabs/CustomTabsClient;
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zznn;->zzbrd:Landroid/support/customtabs/CustomTabsSession;

    :cond_2
    :goto_0
    iget-object p2, p0, Lcom/google/android/gms/internal/zznn;->zzbrd:Landroid/support/customtabs/CustomTabsSession;
...
.method public final zza(Landroid/support/customtabs/CustomTabsClient;)V
    ...
    iget-object p1, p0, Lcom/google/android/gms/internal/zznn;->zzbre:Landroid/support/customtabs/CustomTabsClient;

    const-wide/16 v0, 0x0

    invoke-virtual {p1, v0, v1}, Landroid/support/customtabs/CustomTabsClient;->warmup(J)Z

    iget-object p1, p0, Lcom/google/android/gms/internal/zznn;->zzbrg:Lcom/google/android/gms/internal/zzno;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lcom/google/android/gms/internal/zzno;->zzjf()V
...
.method public final zzc(Landroid/app/Activity;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/zznn;->zzbrd:Landroid/support/customtabs/CustomTabsSession;

    iput-object p1, p0, Lcom/google/android/gms/internal/zznn;->zzbrf:Landroid/support/customtabs/CustomTabsServiceConnection;
...
.method public final zzd(Landroid/app/Activity;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/internal/zzfkr;->zzff(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_1
    new-instance v1, Lcom/google/android/gms/internal/zzfks;

    invoke-direct {v1, p0}, Lcom/google/android/gms/internal/zzfks;-><init>(Lcom/google/android/gms/internal/zzfkt;)V
