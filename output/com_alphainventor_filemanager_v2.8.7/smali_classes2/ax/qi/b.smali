...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lax/qi/b;->a:[J

    const/16 v0, 0xc0

    new-array v0, v0, [B

    iput-object v0, p0, Lax/qi/b;->b:[B

    invoke-direct {p0, p1}, Lax/qi/b;->p(I)V
...
.method private g([BI)V
    ...
    iget-object v2, p0, Lax/qi/b;->a:[J

    aget-wide v3, v2, v1

    invoke-static {p1, p2}, Lax/cj/e;->k([BI)J
    ...
    :cond_0
    invoke-virtual {p0}, Lax/qi/b;->o()[B

    move-result-object p1

    invoke-static {p1}, Lax/dj/b;->b([B)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p1}, Ljava/lang/String;->toLowerCase()Ljava/lang/String;

    invoke-direct {p0}, Lax/qi/b;->k()V
...
.method private h()V
    ...
    iget-object v0, p0, Lax/qi/b;->a:[J

    iget v1, p0, Lax/qi/b;->c:I

    ushr-int/lit8 v1, v1, 0x6

    iget-object v2, p0, Lax/qi/b;->b:[B

    const/4 v3, 0x0

    invoke-static {v0, v3, v1, v2, v3}, Lax/cj/e;->o([JII[BI)V

    iget v0, p0, Lax/qi/b;->c:I

    iput v0, p0, Lax/qi/b;->d:I
...
.method private k()V
    ...
    iget-object v1, v0, Lax/qi/b;->a:[J
...
.method private p(I)V
    ...
    invoke-direct {p0, p1}, Lax/qi/b;->q(I)V
...
.method private q(I)V
    ...
    :goto_0
    iget-object v3, p0, Lax/qi/b;->a:[J
    ...
    invoke-static {v2, v1}, Lax/cj/a;->d([BB)V

    iput v1, p0, Lax/qi/b;->d:I

    iput-boolean v1, p0, Lax/qi/b;->f:Z

    sub-int/2addr v0, p1

    div-int/lit8 v0, v0, 0x2

    iput v0, p0, Lax/qi/b;->e:I
...
.method private r()V
    ...
    iget-object v0, p0, Lax/qi/b;->b:[B

    iget v1, p0, Lax/qi/b;->d:I
    ...
    iget v2, p0, Lax/qi/b;->c:I

    const/4 v3, 0x0

    if-ne v1, v2, :cond_0

    invoke-direct {p0, v0, v3}, Lax/qi/b;->g([BI)V
    ...
    iget-object v6, p0, Lax/qi/b;->a:[J

    aget-wide v7, v6, v2

    iget-object v9, p0, Lax/qi/b;->b:[B

    invoke-static {v9, v4}, Lax/cj/e;->k([BI)J
    ...
    iput v3, p0, Lax/qi/b;->d:I

    iput-boolean v5, p0, Lax/qi/b;->f:Z
...
.method public a()V
    ...
    invoke-direct {p0, v0}, Lax/qi/b;->p(I)V
...
.method public b([BII)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lax/qi/b;->m([BII)V
...
.method public d(B)V
    ...
    invoke-virtual {p0, p1}, Lax/qi/b;->l(B)V
...
.method protected l(B)V
    ...
    iget v0, p0, Lax/qi/b;->d:I

    rem-int/lit8 v1, v0, 0x8

    if-nez v1, :cond_2

    iget-boolean v1, p0, Lax/qi/b;->f:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lax/qi/b;->b:[B
    ...
    iget p1, p0, Lax/qi/b;->c:I

    if-ne v0, p1, :cond_0

    const/4 p1, 0x0

    invoke-direct {p0, v1, p1}, Lax/qi/b;->g([BI)V

    iput p1, p0, Lax/qi/b;->d:I
...
.method protected m([BII)V
    ...
    iget-object v4, p0, Lax/qi/b;->b:[B
    ...
    invoke-direct {p0, p1, v0}, Lax/qi/b;->g([BI)V
    ...
    iget-object p3, p0, Lax/qi/b;->b:[B
...
.method protected n(II)V
    ...
    iget-boolean v2, p0, Lax/qi/b;->f:Z
...
.method protected o()[B
    ...
    invoke-static {v4, v5, v0, v2}, Lax/cj/e;->n(J[BI)V
...
.method protected s([BIJ)V
    ...
    iget v2, p0, Lax/qi/b;->d:I

    if-nez v2, :cond_1

    invoke-direct {p0}, Lax/qi/b;->h()V
    ...
    iget v6, p0, Lax/qi/b;->c:I

    iget v7, p0, Lax/qi/b;->d:I
