...
.field private static i:Landroidx/appcompat/widget/e0;

.field private static final j:Landroidx/appcompat/widget/e0$c;
...
.field private g:Landroidx/appcompat/widget/e0$e;
...
.method private a(Ljava/lang/String;Landroidx/appcompat/widget/e0$d;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/e0;->b:Lax/r/a;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/e0;->b:Lax/r/a;
...
.method private declared-synchronized b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Lax/r/d;->l(JLjava/lang/Object;)V
    :try_end_0
...
.method private c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .line 6
    :cond_1
    invoke-virtual {v0, p2, p3}, Lax/r/h;->b(ILjava/lang/Object;)V
...
.method private f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    invoke-direct {p0, p1, v1, v2}, Landroidx/appcompat/widget/e0;->i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    :cond_1
    iget-object v3, p0, Landroidx/appcompat/widget/e0;->g:Landroidx/appcompat/widget/e0$e;
    ...
    .line 8
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/e0$e;->c(Landroidx/appcompat/widget/e0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 10
    invoke-direct {p0, p1, v1, v2, p2}, Landroidx/appcompat/widget/e0;->b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private declared-synchronized i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Lax/r/d;->h(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Lax/r/d;->e(J)V
    :try_end_2
...
.method public static declared-synchronized l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/e0$c;->j(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 3
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/e0$c;->k(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private n(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    invoke-virtual {p1, p2}, Lax/r/h;->g(I)Ljava/lang/Object;
...
.method private static p(Landroidx/appcompat/widget/e0;)V
    .locals 2
    ...
    .line 2
    new-instance v0, Landroidx/appcompat/widget/e0$f;

    invoke-direct {v0}, Landroidx/appcompat/widget/e0$f;-><init>()V

    const-string v1, "vector"

    invoke-direct {p0, v1, v0}, Landroidx/appcompat/widget/e0;->a(Ljava/lang/String;Landroidx/appcompat/widget/e0$d;)V
...
.method private r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lax/r/g;->isEmpty()Z
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/widget/e0;->c:Lax/r/h;
    ...
    .line 3
    invoke-virtual {v0, p2}, Lax/r/h;->g(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/e0;->b:Lax/r/a;

    .line 5
    invoke-virtual {v3, v0}, Lax/r/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/e0;->c:Lax/r/h;
    ...
    .line 13
    invoke-direct {p0, p1, v4, v5}, Landroidx/appcompat/widget/e0;->i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .line 19
    iget-object v8, p0, Landroidx/appcompat/widget/e0;->c:Lax/r/h;

    invoke-virtual {v8, p2, v3}, Lax/r/h;->b(ILjava/lang/Object;)V

    .line 20
    iget-object v8, p0, Landroidx/appcompat/widget/e0;->b:Lax/r/a;

    invoke-virtual {v8, v3}, Lax/r/g;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroidx/appcompat/widget/e0$d;
    ...
    .line 22
    invoke-interface {v3, p1, v1, v7, v8}, Landroidx/appcompat/widget/e0$d;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    invoke-direct {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/e0;->b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 27
    iget-object p1, p0, Landroidx/appcompat/widget/e0;->c:Lax/r/h;

    invoke-virtual {p1, p2, v2}, Lax/r/h;->b(ILjava/lang/Object;)V
...
.method private v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    :cond_0
    invoke-static {p4}, Lax/d0/a;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    .line 5
    invoke-static {p4, v0}, Lax/d0/a;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-static {p4, p1}, Lax/d0/a;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

    goto :goto_0

    .line 8
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/e0;->g:Landroidx/appcompat/widget/e0$e;

    if-eqz v0, :cond_2

    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/e0$e;->e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method static w(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/l0;[I)V
    .locals 2
...
.method declared-synchronized k(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/e0;->d(Landroid/content/Context;)V

    .line 2
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/e0;->r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/e0;->f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/e0;->v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/e0;->n(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/e0$e;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    invoke-direct {p0, p1, p2, v0}, Landroidx/appcompat/widget/e0;->c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method o(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/e0$e;->b(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized t(Landroid/content/Context;Landroidx/appcompat/widget/p0;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p1, p3}, Landroidx/appcompat/widget/e0;->r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/p0;->d(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-direct {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/e0;->v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized u(Landroidx/appcompat/widget/e0$e;)V
    .locals 0
    ...
    .line 1
    :try_start_0
    iput-object p1, p0, Landroidx/appcompat/widget/e0;->g:Landroidx/appcompat/widget/e0$e;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/e0$e;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
