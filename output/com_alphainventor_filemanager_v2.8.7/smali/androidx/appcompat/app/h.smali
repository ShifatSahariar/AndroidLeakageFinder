...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/h;->e:Ljava/util/Map;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-static {p1}, Lax/l0/w;->J(Landroid/view/View;)Z
...
.method private r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/app/h;->e:Ljava/util/Map;
...
.method private static t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 6
    instance-of p1, p0, Lax/l/c;

    if-eqz p1, :cond_2

    move-object p1, p0

    check-cast p1, Lax/l/c;

    .line 7
    invoke-virtual {p1}, Lax/l/c;->b()I
    ...
    invoke-direct {p1, p0, p2}, Lax/l/c;-><init>(Landroid/content/Context;I)V
...
.method protected k(Landroid/content/Context;Landroid/util/AttributeSet;)Lax/n/b;
    .locals 1

    .line 1
    new-instance v0, Lax/n/b;

    invoke-direct {v0, p1, p2}, Lax/n/b;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected l(Landroid/content/Context;Landroid/util/AttributeSet;)Lax/n/c;
    .locals 1

    .line 1
    new-instance v0, Lax/n/c;

    invoke-direct {v0, p1, p2}, Lax/n/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 14
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    .line 16
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    .line 18
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/q;
    ...
    .line 20
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    .line 22
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Lax/n/c;
    ...
    .line 26
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/u;
    ...
    .line 28
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/o;
    ...
    .line 32
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/h;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Lax/n/b;
