...
.field private l0:Landroidx/appcompat/view/menu/j$a;

.field m0:Landroid/view/ViewTreeObserver;

.field private n0:Landroid/widget/PopupWindow$OnDismissListener;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/b;->p0:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->Z:Lax/n/g;

    const/4 v0, 0x0

    .line 7
    iput v0, p0, Landroidx/appcompat/view/menu/b;->a0:I

    .line 8
    iput v0, p0, Landroidx/appcompat/view/menu/b;->b0:I

    .line 9
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->P:Landroid/content/Context;

    .line 10
    iput-object p2, p0, Landroidx/appcompat/view/menu/b;->c0:Landroid/view/View;
    ...
    .line 14
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/b;->j0:Z
    ...
    iput p2, p0, Landroidx/appcompat/view/menu/b;->e0:I
...
.method private D()I
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->c0:Landroid/view/View;
...
.method private E(I)I
    ...
    .line 4
    iget-object v4, p0, Landroidx/appcompat/view/menu/b;->d0:Landroid/view/View;

    invoke-virtual {v4, v3}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    .line 5
    iget v4, p0, Landroidx/appcompat/view/menu/b;->e0:I
...
.method private F(Landroidx/appcompat/view/menu/e;)V
    ...
    sget v3, Landroidx/appcompat/view/menu/b;->p0:I
    ...
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/b;->j0:Z
    ...
    .line 8
    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->z()Landroidx/appcompat/widget/d0;

    move-result-object v4

    .line 9
    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/c0;->p(Landroid/widget/ListAdapter;)V

    .line 10
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/c0;->F(I)V

    .line 11
    iget v1, p0, Landroidx/appcompat/view/menu/b;->b0:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/c0;->G(I)V
    ...
    .line 15
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/d0;->U(Z)V

    .line 16
    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/d0;->R(Ljava/lang/Object;)V
    ...
    .line 18
    :goto_2
    iput v8, p0, Landroidx/appcompat/view/menu/b;->e0:I
    ...
    .line 20
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/c0;->D(Landroid/view/View;)V
    ...
    .line 21
    iget-object v12, p0, Landroidx/appcompat/view/menu/b;->c0:Landroid/view/View;
    ...
    .line 23
    iget v12, p0, Landroidx/appcompat/view/menu/b;->b0:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/b;->c0:Landroid/view/View;
    ...
    .line 28
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/b;->b0:I
    ...
    .line 31
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/c0;->l(I)V

    .line 32
    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/c0;->M(Z)V

    .line 33
    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/c0;->j(I)V

    goto :goto_7

    .line 34
    :cond_9
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/b;->f0:Z

    if-eqz v2, :cond_a

    .line 35
    iget v2, p0, Landroidx/appcompat/view/menu/b;->h0:I

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/c0;->l(I)V

    .line 36
    :cond_a
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/b;->g0:Z
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/c0;->j(I)V
    ...
    .line 39
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/c0;->H(Landroid/graphics/Rect;)V

    .line 40
    :goto_7
    new-instance v2, Landroidx/appcompat/view/menu/b$d;

    iget v3, p0, Landroidx/appcompat/view/menu/b;->e0:I

    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Landroidx/appcompat/widget/d0;Landroidx/appcompat/view/menu/e;I)V
    ...
    .line 42
    invoke-virtual {v4}, Landroidx/appcompat/widget/c0;->a()V

    .line 43
    invoke-virtual {v4}, Landroidx/appcompat/widget/c0;->h()Landroid/widget/ListView;
    ...
    .line 45
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/b;->k0:Z
...
.method private z()Landroidx/appcompat/widget/d0;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/d0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 2
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->Z:Lax/n/g;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/d0;->T(Lax/n/g;)V

    .line 3
    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/c0;->L(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 4
    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/c0;->K(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 5
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->c0:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/c0;->D(Landroid/view/View;)V

    .line 6
    iget v1, p0, Landroidx/appcompat/view/menu/b;->b0:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/c0;->G(I)V

    const/4 v1, 0x1

    .line 7
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/c0;->J(Z)V

    const/4 v1, 0x2

    .line 8
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/c0;->I(I)V
...
.method public a()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->d0:Landroid/view/View;

    if-eqz v0, :cond_4

    .line 6
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->m0:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->m0:Landroid/view/ViewTreeObserver;
    ...
    .line 9
    :cond_3
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->d0:Landroid/view/View;
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    .line 7
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/b;->o0:Z
    ...
    .line 8
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/d0;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/d0;->S(Ljava/lang/Object;)V

    .line 9
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/d0;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/c0;->E(I)V

    .line 10
    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/d0;
    ...
    iput v1, p0, Landroidx/appcompat/view/menu/b;->e0:I
    ...
    .line 15
    iget-object p2, p0, Landroidx/appcompat/view/menu/b;->l0:Landroidx/appcompat/view/menu/j$a;
    ...
    .line 17
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->m0:Landroid/view/ViewTreeObserver;
    ...
    .line 20
    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/b;->m0:Landroid/view/ViewTreeObserver;

    .line 21
    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->d0:Landroid/view/View;
    ...
    .line 23
    :cond_7
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->n0:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public c()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/c0;->c()Z
...
.method public dismiss()V
    ...
    .line 5
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/d0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/c0;->c()Z
    ...
    .line 6
    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/d0;
...
.method public e(Landroidx/appcompat/view/menu/m;)Z
    ...
    .line 6
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->l0:Landroidx/appcompat/view/menu/j$a;
...
.method public k(Landroidx/appcompat/view/menu/j$a;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->l0:Landroidx/appcompat/view/menu/j$a;
...
.method public onDismiss()V
    ...
    .line 3
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/d0;

    invoke-virtual {v4}, Landroidx/appcompat/widget/c0;->c()Z
...
.method public p(Landroid/view/View;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->c0:Landroid/view/View;

    .line 3
    iget v0, p0, Landroidx/appcompat/view/menu/b;->a0:I
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/b;->b0:I
...
.method public r(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/b;->j0:Z
...
.method public t(I)V
    ...
    .line 1
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/b;->f0:Z
...
.method public u(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->n0:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public v(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/b;->k0:Z
...
.method public w(I)V
    ...
    .line 1
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/b;->g0:Z

    .line 2
    iput p1, p0, Landroidx/appcompat/view/menu/b;->i0:I
