...
.method static synthetic d4(Lax/u1/k;)Landroid/widget/ListView;
    .locals 0

    .line 1
    iget-object p0, p0, Lax/u1/k;->c1:Landroid/widget/ListView;

    return-object p0
.end method

.method static synthetic e4(Lax/u1/k;)Lax/o2/o;
    .locals 0

    .line 1
    iget-object p0, p0, Lax/u1/k;->f1:Lax/o2/o;

    return-object p0
.end method

.method static synthetic f4(Lax/u1/k;)Lax/o2/b;
    .locals 0

    .line 1
    iget-object p0, p0, Lax/u1/k;->g1:Lax/o2/b;

    return-object p0
.end method

.method static synthetic g4(Lax/u1/k;I)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lax/u1/k;->q4(I)Z
...
.method static synthetic h4(Lax/u1/k;Ljava/util/List;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lax/u1/k;->r4(Ljava/util/List;)V

    return-void
.end method

.method static synthetic i4(Lax/u1/k;Ljava/util/List;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lax/u1/k;->o4(Ljava/util/List;)V

    return-void
.end method

.method static synthetic j4(Lax/u1/k;Ljava/util/List;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lax/u1/k;->n4(Ljava/util/List;)V

    return-void
.end method

.method static synthetic k4(Lax/u1/k;Ljava/util/List;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lax/u1/k;->l4(Ljava/util/List;)V
...
.method private m4()V
    ...
    iput-object v0, p0, Lax/u1/k;->d1:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lax/u1/k;->e1:Landroid/view/View;

    .line 3
    iget-object v0, p0, Lax/u1/k;->d1:Landroid/widget/LinearLayout;
    ...
    .line 4
    iget-object v0, p0, Lax/u1/k;->c1:Landroid/widget/ListView;

    iget-object v1, p0, Lax/u1/k;->d1:Landroid/widget/LinearLayout;
...
.method private o4(Ljava/util/List;)V
    ...
    .line 5
    :cond_1
    invoke-static {v0}, Lax/r1/l;->U2(Ljava/util/List;)Lax/r1/l;
...
.method private q4(I)Z
    ...
    .line 1
    :cond_0
    invoke-virtual {p0}, Lax/u1/k;->p4()Ljava/util/List;
    ...
    iget-object v1, p0, Lax/u1/k;->f1:Lax/o2/o;
    ...
    .line 4
    iget-object v1, p0, Lax/u1/k;->c1:Landroid/widget/ListView;
...
.method private s4()V
    ...
    .line 1
    iget-object v0, p0, Lax/u1/k;->g1:Lax/o2/b;

    new-instance v1, Lax/u1/k$d;

    invoke-direct {v1, p0}, Lax/u1/k$d;-><init>(Lax/u1/k;)V
    ...
    new-instance v1, Lax/u1/k$e;

    invoke-direct {v1, p0}, Lax/u1/k$e;-><init>(Lax/u1/k;)V
    ...
    new-instance v1, Lax/u1/k$f;

    invoke-direct {v1, p0}, Lax/u1/k$f;-><init>(Lax/u1/k;)V
...
.method public A1(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object p2, p0, Lax/u1/k;->b1:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;
    ...
    iput-object p2, p0, Lax/u1/k;->g1:Lax/o2/b;

    .line 6
    invoke-direct {p0}, Lax/u1/k;->s4()V
    ...
    iput-object p1, p0, Lax/u1/k;->c1:Landroid/widget/ListView;

    .line 8
    invoke-direct {p0}, Lax/u1/k;->m4()V

    .line 9
    iget-object p1, p0, Lax/u1/k;->c1:Landroid/widget/ListView;
    ...
    new-instance p2, Lax/u1/k$a;

    invoke-direct {p2, p0}, Lax/u1/k$a;-><init>(Lax/u1/k;)V
    ...
    .line 11
    new-instance p1, Lax/u1/k$b;

    invoke-direct {p1, p0}, Lax/u1/k$b;-><init>(Lax/u1/k;)V
    ...
    iput-object p2, p0, Lax/u1/k;->f1:Lax/o2/o;
    ...
    new-instance p2, Lax/u1/k$c;

    invoke-direct {p2, p0}, Lax/u1/k$c;-><init>(Lax/u1/k;)V
...
.method public B3(Z)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Lax/u1/k;->f1:Lax/o2/o;
...
.method public F(I)V
    ...
    .line 4
    invoke-virtual {p0, v5}, Lax/u1/k;->B3(Z)V
...
.method public U()V
    ...
    .line 1
    invoke-virtual {p0, v0}, Lax/u1/k;->B3(Z)V
...
.method public p4()Ljava/util/List;
    ...
    .line 5
    :try_start_0
    iget-object v3, p0, Lax/u1/k;->f1:Lax/o2/o;
...
.method public q1(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1}, Lcom/alphainventor/filemanager/activity/MainActivity;->z2()V
...
.method protected u3()V
    ...
    .line 4
    iget-object v0, p0, Lax/u1/k;->e1:Landroid/view/View;
...
.method protected v3(Lax/u1/g$p;)V
    ...
    .line 3
    :cond_0
    iget-object p1, p0, Lax/u1/k;->g1:Lax/o2/b;
    ...
    .line 5
    iget-object p1, p0, Lax/u1/k;->e1:Landroid/view/View;
...
.method public z(Lax/j1/f;I)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lax/u1/k;->B3(Z)V
