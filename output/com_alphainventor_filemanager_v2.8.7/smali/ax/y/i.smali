...
.field private final c:Lax/y/h$d;
...
# direct methods
.method constructor <init>(Lax/y/h$d;)V
    .locals 13
    ...
    iput-object v0, p0, Lax/y/i;->f:Ljava/util/List;
    ...
    iput-object v0, p0, Lax/y/i;->g:Landroid/os/Bundle;

    .line 4
    iput-object p1, p0, Lax/y/i;->c:Lax/y/h$d;

    .line 5
    iget-object v0, p1, Lax/y/h$d;->a:Landroid/content/Context;

    iput-object v0, p0, Lax/y/i;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lax/y/h$d;->a:Landroid/content/Context;

    iget-object v4, p1, Lax/y/h$d;->L:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Lax/y/h$d;->T:Landroid/app/Notification;

    .line 10
    iget-object v3, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lax/y/h$d;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lax/y/h$d;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lax/y/h$d;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lax/y/h$d;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lax/y/h$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lax/y/h$d;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lax/y/h$d;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lax/y/h$d;->u:I

    iget v9, p1, Lax/y/h$d;->v:I

    iget-boolean v10, p1, Lax/y/h$d;->w:Z
    ...
    .line 29
    iget-object v4, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;
    ...
    .line 30
    iget-object v0, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lax/y/h$d;->r:Ljava/lang/CharSequence;
    ...
    iget-boolean v8, p1, Lax/y/h$d;->o:Z
    ...
    check-cast v8, Lax/y/h$a;

    .line 34
    invoke-direct {p0, v8}, Lax/y/i;->b(Lax/y/h$a;)V

    goto :goto_5

    .line 35
    :cond_6
    iget-object v0, p1, Lax/y/h$d;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 36
    iget-object v8, p0, Lax/y/i;->g:Landroid/os/Bundle;
    ...
    .line 38
    iget-boolean v0, p1, Lax/y/h$d;->A:Z

    if-eqz v0, :cond_8

    .line 39
    iget-object v0, p0, Lax/y/i;->g:Landroid/os/Bundle;
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Lax/y/h$d;->x:Ljava/lang/String;
    ...
    .line 42
    iget-boolean v0, p1, Lax/y/h$d;->y:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Lax/y/h$d;->z:Ljava/lang/String;
    ...
    .line 47
    :cond_b
    iget-object v0, p1, Lax/y/h$d;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lax/y/i;->d:Landroid/widget/RemoteViews;

    .line 48
    iget-object v0, p1, Lax/y/h$d;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lax/y/i;->e:Landroid/widget/RemoteViews;
    ...
    .line 50
    iget-object v8, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lax/y/h$d;->n:Z
    ...
    .line 51
    iget-object v8, p1, Lax/y/h$d;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lax/y/i;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lax/y/h$d;->W:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lax/y/i;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 53
    iget-object v9, p0, Lax/y/i;->g:Landroid/os/Bundle;
    ...
    iget-boolean v8, p1, Lax/y/h$d;->y:Z
    ...
    iget-object v8, p1, Lax/y/h$d;->H:Landroid/app/Notification;
    ...
    .line 66
    iget-object v0, p1, Lax/y/h$d;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lax/y/i;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lax/y/h$d;->W:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lax/y/i;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Lax/y/h$d;->W:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Lax/y/h$d;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lax/y/i;->i:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Lax/y/h$d;->d:Ljava/util/ArrayList;
    ...
    .line 73
    invoke-virtual {p1}, Lax/y/h$d;->e()Landroid/os/Bundle;
    ...
    .line 77
    :goto_9
    iget-object v11, p1, Lax/y/h$d;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lax/y/h$d;->d:Ljava/util/ArrayList;
    ...
    check-cast v12, Lax/y/h$a;

    .line 80
    invoke-static {v12}, Lax/y/j;->b(Lax/y/h$a;)Landroid/os/Bundle;
    ...
    .line 87
    iget-object v3, p1, Lax/y/h$d;->V:Landroid/graphics/drawable/Icon;
    ...
    .line 91
    iget-object v3, p1, Lax/y/h$d;->I:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Lax/y/h$d;->J:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Lax/y/h$d;->K:Landroid/widget/RemoteViews;
    ...
    iget-object v9, p1, Lax/y/h$d;->N:Ljava/lang/String;
    ...
    check-cast v4, Lax/y/l;

    .line 110
    iget-object v7, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lax/y/l;->h()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Lax/y/h$d;->R:Z
    ...
    iget-object v7, p1, Lax/y/h$d;->S:Lax/y/h$c;

    .line 114
    invoke-static {v7}, Lax/y/h$c;->a(Lax/y/h$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 116
    iget-object v4, p1, Lax/y/h$d;->O:Lax/z/b;
    ...
    invoke-virtual {v4}, Lax/z/b;->c()Landroid/content/LocusId;
    ...
    .line 118
    :cond_1c
    iget-boolean p1, p1, Lax/y/h$d;->U:Z

    if-eqz p1, :cond_1f

    .line 119
    iget-object p1, p0, Lax/y/i;->c:Lax/y/h$d;

    iget-boolean p1, p1, Lax/y/h$d;->y:Z

    if-eqz p1, :cond_1d

    .line 120
    iput v5, p0, Lax/y/i;->h:I

    goto :goto_b

    .line 121
    :cond_1d
    iput v6, p0, Lax/y/i;->h:I

    .line 122
    :goto_b
    iget-object p1, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;
    ...
    .line 126
    iget-object v2, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lax/y/h$d;->x:Ljava/lang/String;
...
.method private b(Lax/y/h$a;)V
    ...
    .line 2
    invoke-virtual {p1}, Lax/y/h$a;->f()Landroidx/core/graphics/drawable/IconCompat;
    ...
    .line 11
    :goto_2
    invoke-virtual {p1}, Lax/y/h$a;->g()[Lax/y/m;
    ...
    .line 13
    invoke-static {v1}, Lax/y/m;->b([Lax/y/m;)[Landroid/app/RemoteInput;
    ...
    .line 15
    :cond_3
    invoke-virtual {p1}, Lax/y/h$a;->d()Landroid/os/Bundle;
    ...
    .line 18
    :goto_4
    invoke-virtual {p1}, Lax/y/h$a;->b()Z
    ...
    .line 22
    :cond_5
    invoke-virtual {p1}, Lax/y/h$a;->h()I
    ...
    .line 25
    invoke-virtual {p1}, Lax/y/h$a;->k()Z
    ...
    .line 26
    :cond_7
    invoke-virtual {p1}, Lax/y/h$a;->i()Z
    ...
    .line 30
    iget-object v0, p0, Lax/y/i;->f:Ljava/util/List;

    iget-object v1, p0, Lax/y/i;->b:Landroid/app/Notification$Builder;

    .line 31
    invoke-static {v1, p1}, Lax/y/j;->f(Landroid/app/Notification$Builder;Lax/y/h$a;)Landroid/os/Bundle;
...
.method private static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lax/r/b;-><init>(I)V

    .line 2
    invoke-virtual {v0, p0}, Lax/r/b;->addAll(Ljava/util/Collection;)Z
...
.method private static f(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v1, Lax/y/l;

    .line 3
    invoke-virtual {v1}, Lax/y/l;->g()Ljava/lang/String;
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Lax/y/i;->c:Lax/y/h$d;

    iget-object v0, v0, Lax/y/h$d;->q:Lax/y/h$e;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Lax/y/h$e;->b(Lax/y/g;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Lax/y/h$e;->j(Lax/y/g;)Landroid/widget/RemoteViews;
    ...
    .line 4
    :goto_0
    invoke-virtual {p0}, Lax/y/i;->d()Landroid/app/Notification;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Lax/y/i;->c:Lax/y/h$d;

    iget-object v1, v1, Lax/y/h$d;->I:Landroid/widget/RemoteViews;
    ...
    .line 9
    invoke-virtual {v0, p0}, Lax/y/h$e;->i(Lax/y/g;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Lax/y/i;->c:Lax/y/h$d;

    iget-object v4, v4, Lax/y/h$d;->q:Lax/y/h$e;

    .line 12
    invoke-virtual {v4, p0}, Lax/y/h$e;->k(Lax/y/g;)Landroid/widget/RemoteViews;
    ...
    .line 14
    invoke-static {v2}, Lax/y/h;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 15
    invoke-virtual {v0, v1}, Lax/y/h$e;->a(Landroid/os/Bundle;)V
...
.method protected d()Landroid/app/Notification;
    ...
    .line 6
    invoke-direct {p0, v0}, Lax/y/i;->g(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lax/y/i;->g:Landroid/os/Bundle;
    ...
    .line 11
    iget-object v1, p0, Lax/y/i;->d:Landroid/widget/RemoteViews;
    ...
    .line 13
    :cond_4
    iget-object v1, p0, Lax/y/i;->e:Landroid/widget/RemoteViews;
    ...
    .line 15
    :cond_5
    iget-object v1, p0, Lax/y/i;->i:Landroid/widget/RemoteViews;
    ...
    .line 34
    invoke-static {v0}, Lax/y/j;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 43
    invoke-static {v0}, Lax/y/h;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Lax/y/i;->g:Landroid/os/Bundle;
    ...
    .line 49
    iget-object v1, p0, Lax/y/i;->f:Ljava/util/List;

    .line 50
    invoke-static {v1}, Lax/y/j;->a(Ljava/util/List;)Landroid/util/SparseArray;
