...
# static fields
.field public static final b:Lax/z4/b1$a;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lax/z4/b1$a;

    invoke-direct {v0}, Lax/z4/b1$a;-><init>()V

    sput-object v0, Lax/z4/b1$a;->b:Lax/z4/b1$a;
...
.method public bridge synthetic s(Lax/l5/i;Z)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lax/z4/b1$a;->u(Lax/l5/i;Z)Lax/z4/b1;
...
.method public bridge synthetic t(Ljava/lang/Object;Lax/l5/f;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lax/z4/b1$a;->v(Lax/z4/b1;Lax/l5/f;Z)V

    return-void
.end method

.method public u(Lax/l5/i;Z)Lax/z4/b1;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-virtual {v0, p1}, Lax/z4/q0$b;->s(Lax/l5/i;)Lax/z4/q0;
    ...
    :cond_1
    const-string v3, "highlight_spans"
    ...
    .line 9
    sget-object v1, Lax/z4/e0$a;->b:Lax/z4/e0$a;

    invoke-static {v1}, Lax/n4/d;->c(Lax/n4/c;)Lax/n4/c;
    ...
    .line 11
    new-instance v2, Lax/z4/b1;

    invoke-direct {v2, v0, v1}, Lax/z4/b1;-><init>(Lax/z4/q0;Ljava/util/List;)V
    ...
    .line 13
    :cond_4
    invoke-virtual {v2}, Lax/z4/b1;->b()Ljava/lang/String;
...
.method public v(Lax/z4/b1;Lax/l5/f;Z)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    iget-object v1, p1, Lax/z4/b1;->a:Lax/z4/q0;

    invoke-virtual {v0, v1, p2}, Lax/z4/q0$b;->t(Lax/z4/q0;Lax/l5/f;)V

    .line 4
    iget-object v0, p1, Lax/z4/b1;->b:Ljava/util/List;
    ...
    .line 6
    sget-object v0, Lax/z4/e0$a;->b:Lax/z4/e0$a;
