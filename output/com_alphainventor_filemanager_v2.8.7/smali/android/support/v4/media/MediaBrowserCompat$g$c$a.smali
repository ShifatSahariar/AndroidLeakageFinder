...
.field final synthetic Q:Landroid/support/v4/media/MediaBrowserCompat$g$c;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$g$c;Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->Q:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->O:Landroid/content/ComponentName;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->P:Landroid/os/IBinder;
...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->O:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->P:Landroid/os/IBinder;
    ...
    .line 3
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->Q:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;

    invoke-virtual {v2}, Landroid/support/v4/media/MediaBrowserCompat$g;->f()V
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->P:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->Q:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
    ...
    .line 10
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->Q:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$a;->Q:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
