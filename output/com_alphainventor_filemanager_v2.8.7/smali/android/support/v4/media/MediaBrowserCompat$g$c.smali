...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$g;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
...
.method private b(Ljava/lang/Runnable;)V
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
...
.method a(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;

    iget-object p1, p1, Landroid/support/v4/media/MediaBrowserCompat$g;->b:Landroid/content/ComponentName;
    ...
    iget-object p1, p1, Landroid/support/v4/media/MediaBrowserCompat$g;->h:Landroid/support/v4/media/MediaBrowserCompat$g$c;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/media/MediaBrowserCompat$g$c;->b(Ljava/lang/Runnable;)V
