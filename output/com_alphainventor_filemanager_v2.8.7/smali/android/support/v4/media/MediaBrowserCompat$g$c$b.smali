...
.field final synthetic P:Landroid/support/v4/media/MediaBrowserCompat$g$c;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$g$c;Landroid/content/ComponentName;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$b;->P:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$b;->O:Landroid/content/ComponentName;
...
.method public run()V
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$b;->O:Landroid/content/ComponentName;
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$b;->P:Landroid/support/v4/media/MediaBrowserCompat$g$c;

    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$g$c;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
    ...
    .line 3
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$g$c$b;->P:Landroid/support/v4/media/MediaBrowserCompat$g$c;
