...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lax/i1/b;Landroid/os/Bundle;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p6}, Landroid/support/v4/media/session/MediaSessionCompat$i;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lax/i1/b;Landroid/os/Bundle;)V
...
.method J(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 3
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->J(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public l(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->l(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
