...
.method public c(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/b;->F4(Landroid/net/Uri;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public d(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/b;->a2(Landroid/net/Uri;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public e(J)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/b;->R4(J)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public g(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/b;->N(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
