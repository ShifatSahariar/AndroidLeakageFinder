...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lax/i1/b;Landroid/os/Bundle;)V
    .locals 3
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$i;->F:Lax/a1/j$a;
    ...
    invoke-direct {p2, p1, p3, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/b;Lax/i1/b;)V
...
.method private A(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->R(Landroid/support/v4/media/MediaMetadataCompat;)V
    :try_end_0
...
.method private B(Ljava/util/List;)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->B3(Ljava/util/List;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private C(Ljava/lang/CharSequence;)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->V0(Ljava/lang/CharSequence;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private D(I)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->W(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private E()V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1}, Landroid/support/v4/media/session/a;->t1()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private F(I)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->b3(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private G(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    .locals 2
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->r5(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private z(Landroid/os/Bundle;)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->g3(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
# virtual methods
.method H(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    .locals 1
...
.method J(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    .locals 0
...
.method K()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->o(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->j(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->J(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public a()V
    ...
    .line 3
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->K()V

    .line 4
    invoke-direct {p0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->E()V

    const/4 v0, 0x0

    .line 5
    invoke-virtual {p0, v0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->l(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method public e(Ljava/util/List;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->B(Ljava/util/List;)V
...
.method public f(Lax/a1/c;)V
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$i;->q:Lax/a1/c;
...
.method public g(Landroid/os/Bundle;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->z(Landroid/os/Bundle;)V
...
.method public j(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->G(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 8
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->H(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public m(Ljava/lang/CharSequence;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->C(Ljava/lang/CharSequence;)V

    return-void
.end method

.method public n()Landroid/support/v4/media/session/MediaSessionCompat$b;
    .locals 2
...
.method public o(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 5
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->A(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public q()Lax/a1/c;
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$i;->q:Lax/a1/c;
...
.method public r(I)V
    ...
    .line 3
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->D(I)V
