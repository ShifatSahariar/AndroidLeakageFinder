...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/MediaBrowserCompat$g;->j()V
.end annotation
...
# instance fields
.field final synthetic O:Landroid/support/v4/media/MediaBrowserCompat$g;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$g;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$a;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
...
.method public run()V
    ...
    .line 1
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$g$a;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$g$a;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
    ...
    .line 11
    :try_start_0
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$g$a;->O:Landroid/support/v4/media/MediaBrowserCompat$g;

    iget-object v4, v3, Landroid/support/v4/media/MediaBrowserCompat$g;->a:Landroid/content/Context;
    ...
    invoke-virtual {v1}, Landroid/support/v4/media/MediaBrowserCompat$g;->g()V
    ...
    .line 17
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$g$a;->O:Landroid/support/v4/media/MediaBrowserCompat$g;
