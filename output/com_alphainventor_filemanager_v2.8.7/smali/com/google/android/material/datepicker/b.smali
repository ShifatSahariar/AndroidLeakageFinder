...
.field private final f:Lax/ga/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILax/ga/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    invoke-static {v0}, Lax/k0/i;->b(I)I
    ...
    .line 11
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lax/ga/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    .line 1
    invoke-static {v1, v2}, Lax/k0/i;->a(ZLjava/lang/Object;)V

    .line 2
    sget-object v1, Lax/n9/a$l;->b2:[I
    ...
    .line 13
    sget v1, Lax/n9/a$l;->g2:I

    .line 14
    invoke-static {p0, p1, v1}, Lax/da/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    .line 15
    sget v1, Lax/n9/a$l;->l2:I
    ...
    .line 25
    invoke-static {p0, v1, v0}, Lax/ga/k;->b(Landroid/content/Context;II)Lax/ga/k$b;

    move-result-object p0

    .line 26
    invoke-virtual {p0}, Lax/ga/k$b;->m()Lax/ga/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILax/ga/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    .line 3
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lax/ga/k;

    invoke-virtual {v0, v2}, Lax/ga/g;->setShapeAppearanceModel(Lax/ga/k;)V

    .line 4
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lax/ga/k;

    invoke-virtual {v1, v2}, Lax/ga/g;->setShapeAppearanceModel(Lax/ga/k;)V

    .line 5
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lax/ga/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Lax/l0/w;->k0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
