...
.method private D(Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Lax/ga/g;
...
.method private u(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lax/ga/g;

    move-result-object v1

    .line 4
    sget v2, Lax/n9/a$b;->i:I

    invoke-static {p1, v2}, Lax/u9/a;->c(Landroid/view/View;I)I
    ...
    .line 5
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILax/ga/g;)V
    ...
    .line 6
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->v(Landroid/widget/AutoCompleteTextView;I[[ILax/ga/g;)V
...
.method private v(Landroid/widget/AutoCompleteTextView;I[[ILax/ga/g;)V
    .locals 5
    ...
    .line 2
    invoke-static {p2, v0, v1}, Lax/u9/a;->f(IIF)I
    ...
    .line 6
    invoke-static {p1, p3}, Lax/l0/w;->k0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 8
    invoke-virtual {p4}, Lax/ga/g;->C()Lax/ga/k;

    move-result-object v4

    invoke-direct {v0, v4}, Lax/ga/g;-><init>(Lax/ga/k;)V
    ...
    invoke-virtual {v0, v4}, Lax/ga/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    .line 11
    invoke-static {p1}, Lax/l0/w;->C(Landroid/view/View;)I
    ...
    .line 13
    invoke-static {p1}, Lax/l0/w;->B(Landroid/view/View;)I
    ...
    .line 15
    invoke-static {p1, p2}, Lax/l0/w;->k0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 16
    invoke-static {p1, p3, p4, v0, v1}, Lax/l0/w;->u0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private w(Landroid/widget/AutoCompleteTextView;I[[ILax/ga/g;)V
    .locals 7

    .line 1
    sget v0, Lax/n9/a$b;->m:I

    invoke-static {p1, v0}, Lax/u9/a;->c(Landroid/view/View;I)I
    ...
    .line 4
    invoke-static {p2, v0, v2}, Lax/u9/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Lax/ga/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-virtual {v1, v0}, Lax/ga/g;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Lax/ga/g;-><init>(Lax/ga/k;)V

    const/4 v0, -0x1

    .line 11
    invoke-virtual {p3, v0}, Lax/ga/g;->setTint(I)V
...
.method private z(FFFI)Lax/ga/g;
    .locals 1

    .line 1
    invoke-static {}, Lax/ga/k;->a()Lax/ga/k$b;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p1}, Lax/ga/k$b;->z(F)Lax/ga/k$b;
    ...
    .line 4
    invoke-virtual {p1, p2}, Lax/ga/k$b;->r(F)Lax/ga/k$b;

    move-result-object p1

    .line 5
    invoke-virtual {p1, p2}, Lax/ga/k$b;->v(F)Lax/ga/k$b;
    ...
    .line 8
    invoke-static {p2, p3}, Lax/ga/g;->m(Landroid/content/Context;F)Lax/ga/g;

    move-result-object p2

    .line 9
    invoke-virtual {p2, p1}, Lax/ga/g;->setShapeAppearanceModel(Lax/ga/k;)V

    const/4 p1, 0x0

    .line 10
    invoke-virtual {p2, p1, p4, p1, p4}, Lax/ga/g;->Y(IIII)V
...
.method a()V
    ...
    .line 10
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Lax/ga/g;
    ...
    .line 11
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Lax/ga/g;

    move-result-object v0

    .line 12
    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Lax/ga/g;
    ...
    sget v0, Lax/n9/a$e;->d:I

    goto :goto_0

    :cond_0
    sget v0, Lax/n9/a$e;->e:I
    ...
    invoke-static {v2, v0}, Lax/h/a;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
