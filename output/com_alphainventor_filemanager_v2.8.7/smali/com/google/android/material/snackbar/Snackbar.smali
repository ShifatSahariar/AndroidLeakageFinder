...
.method private constructor <init>(Landroid/view/ViewGroup;Landroid/view/View;Lax/ha/a;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/snackbar/BaseTransientBottomBar;-><init>(Landroid/view/ViewGroup;Landroid/view/View;Lax/ha/a;)V
...
.method public static Z(Landroid/view/View;Ljava/lang/CharSequence;I)Lcom/google/android/material/snackbar/Snackbar;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/android/material/snackbar/Snackbar;->X(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-static {v1}, Lcom/google/android/material/snackbar/Snackbar;->Y(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_0

    sget v1, Lax/n9/a$h;->p:I

    goto :goto_0

    :cond_0
    sget v1, Lax/n9/a$h;->c:I
    ...
    invoke-direct {v1, p0, v0, v0}, Lcom/google/android/material/snackbar/Snackbar;-><init>(Landroid/view/ViewGroup;Landroid/view/View;Lax/ha/a;)V

    .line 6
    invoke-virtual {v1, p1}, Lcom/google/android/material/snackbar/Snackbar;->d0(Ljava/lang/CharSequence;)Lcom/google/android/material/snackbar/Snackbar;

    .line 7
    invoke-virtual {v1, p2}, Lcom/google/android/material/snackbar/BaseTransientBottomBar;->L(I)Lcom/google/android/material/snackbar/BaseTransientBottomBar;
